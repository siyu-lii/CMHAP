...
class Options:
    ...
    def _initial(self):
        ...
        #                     Model options
        # ===============================================================
        self.parser.add_argument('--in_features', type=int, default=69, help='size of each model layer')
        self.parser.add_argument('--num_stage', type=int, default=8, help='size of each model layer')
        ...
        self.parser.add_argument('--alpha', type=float, default=0.25, help='the RATIO of the label predict loss')
        self.parser.add_argument('--beta', type=float, default=0.15,help="the RATIO of the  multi-scale loss")

        # ===============================================================
        #                     Running options
        # ===============================================================
        self.parser.add_argument('--input_n', type=int, default=50, help='past frame number')
        self.parser.add_argument('--output_n', type=int, default=10, help='future frame number')  #10or25
        ...
        self.parser.add_argument('--test_batch_size', type=int, default=8)
